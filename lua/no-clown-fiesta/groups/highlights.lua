...
function M.highlight(palette, opts)
    return {
        ...
        -- comment test
        Comment = vim.tbl_extend('force', { fg = palette.comment }, opts.styles.comments),
        ...
        CursorLine = { bg = palette.bg_lighter },
        CursorColumn = { bg = palette.alt_bg },
        ColorColumn = { bg = palette.alt_bg },
        NormalFloat = { bg = opts.transparent and palette.none or palette.bg },
        ...
        CurSearch = { fg = palette.alt_bg, bg = palette.orange },
        Search = { bg = palette.line_nr },
        ...
        -- Special = { fg = palette.dark_gray_blue },
