...
function M.highlight(palette, opts)
    return {
        ...
        DiagnosticUnderlineError = vim.tbl_extend('force', { sp = palette.error }, opts.styles.lsp),
        DiagnosticUnderlineWarn = vim.tbl_extend('force', { sp = palette.warning }, opts.styles.lsp),
        DiagnosticUnderlineInfo = vim.tbl_extend('force', { sp = palette.info }, opts.styles.lsp),
        DiagnosticUnderlineHint = vim.tbl_extend('force', { sp = palette.hint }, opts.styles.lsp),
